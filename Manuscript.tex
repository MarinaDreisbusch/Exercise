...
\authorsnames{Josephine Zerna,Christoph Scheffel,Marina Dreisbusch}
...
\leftheader{Zerna, Scheffel and Dreisbusch}
...
Taxonomy (CRediT; https://credit.niso.org/) as follows:  Josephine
Zerna:   conceptualization, writing; Christoph Scheffel:   project
administration, methodology}
\par{Correspondence concerning this article should be addressed
to Christoph
Scheffel, Email: \href{mailto:christoph\_scheffel@tu-dresden.de}{christoph\_scheffel@tu-dresden.de}}
}
...
\pandocbounded{\includegraphics[keepaspectratio]{penguin.jpg}}

This manuscript presents a minimal reproducible example utilizing the
penguins data set to demonstrate scientific workflows in R.
...
\pandocbounded{\includegraphics[keepaspectratio]{Manuscript_files/figure-pdf/fig-bill-length-comparison-1.pdf}}
